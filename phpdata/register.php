...
//variables ra mani gi reset
$username_err = $email_err = $password_err = "";
$username = $email = $password = "";

//send sa sql
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 //kung tama ba username
  if (empty(trim($_POST["username"]))) {
    ...
    if (!ctype_alnum(str_replace(array("@", "-", "_"), "", $username))) {
      ...
      if ($stmt = mysqli_prepare($link, $sql)) {
       //isabay and select ug ning variables
  ...
  //same lng japun sa taas pero sa email na na part
  ...
  //same lng japun sa taas pero sa password maong may dungag
